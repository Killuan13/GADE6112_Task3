...
namespace GADE_POE
{
    ...
    {
        //Constructers
        public RangedUnit(int xPosition, int yPosition, int health, int speed, int attack, int atkRange, char[,] team, bool ifAtk, string[] unit) : base(xPosition, yPosition, health, speed, attack, atkRange, team, ifAtk, unit)
        {
        ...
        public int Attack { get => base.attack; }
